...
namespace PacketMessagingTS.Models
{
	...
	public class DistributionListArray
	{
		...
		public async Task OpenAsync()
		{
			...
			{
                LogHelper.Log(LogLevel.Error, $"Open Distribution List file failed: {e.Message}");
				return;
			}

			catch (Exception e)
			{
                LogHelper.Log(LogLevel.Error, $"Error opening file {file?.Path + distributionListsFileName}, {e}");
				return;
			}
			UpdateDictionary();
		}
		...
		public async Task SaveAsync()
		{
			...
			{
                LogHelper.Log(LogLevel.Error, $"Error saving {distributionListsFileName}, {e}");
				return;
			}
			UpdateDictionary();
			_dataChanged = false;
