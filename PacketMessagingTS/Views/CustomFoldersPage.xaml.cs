...
namespace PacketMessagingTS.Views
{
    ...
    public sealed partial class CustomFoldersPage : Page
    {
        ...
        //public Action<object, RoutedEventArgs> Click { get; private set; }
        ...
        public CustomFoldersPage()
        {
            ...
            ViewModel.CustomFoldersDataGrid = dataGrid;
        }
            ...
            foreach (TabViewItemData tabView in CustomFoldersArray.Instance.CustomFolderList)
            {
                if (currentFolder != tabView.Folder)
                {
                    newMenuItem = new MenuFlyoutItem()
                    {
                        ...
                        //Click += OnMoveToFolderFromContextMenuCommand,
                    };
        ...
        private void DataGrid_Sorting(object sender, DataGridColumnEventArgs e)
        {
            ...
            //int sortColumnNumber = ViewModel.DataGridSortDataDictionary[ViewModel.SelectedTab.Folder].SortColumnNumber;
        ...
        private void DataGrid_RightTapped(object sender, RightTappedRoutedEventArgs e)
        {
            try
            {
                ...
                //if (ViewModel.SelectedMessages.Count > 1)
                //{
                //    msg = ViewModel.SelectedMessages?.FirstOrDefault(m => m.MessageNumber == ViewModel.PacketMessageRightClicked?.MessageNumber);
                //}
                //if (msg is null)
                //{
                //    (sender as DataGrid).SelectedItem = ViewModel.PacketMessageRightClicked;
                //}
                FillMoveLocations(ViewModel.CustomFoldersDataGrid);
            }
            catch (Exception ex)
            {
