...
namespace PacketMessagingTS.Core.Models
{
    ...
    public sealed partial class PacketMessage2
    {
        ...
        public static PacketMessage2 Open(string filePath)
        {
            if (!File.Exists(filePath))
                return null;

            PacketMessage2 packetMessage;
            try
            {
                using (var stream = new FileStream(filePath, FileMode.Open))
                {
                    ...
                    {
                        var serializer = new XmlSerializer(typeof(PacketMessage2));
                        packetMessage = (PacketMessage2)serializer.Deserialize(reader);
                    }
                }
        ...
        //public static PacketMessage2 Open(StorageFile file)
        //      {
        ...
        public void Save(string fileFolder)
        {
            ...
            try
            {
                using (Stream stream = new FileStream(filePath, FileMode.Create))
                {
                    ...
                    {
                        XmlSerializer serializer = new XmlSerializer(typeof(PacketMessage2));
        ...
        public static async Task<List<PacketMessage2>> GetPacketMessages(string fileFolder)
        {
            List<PacketMessage2> packetMessages = new List<PacketMessage2>();
            ...
            if (!string.IsNullOrEmpty(fileFolder) && Directory.Exists(fileFolder))
            {
                await Task.Run(() =>
                {
                    ...
                    foreach (FileInfo file in info)
                    {
                        ...
                        PacketMessage2 packetMessage = Open(filePath);
        ...
        //public static async Task<List<PacketMessage2>> GetPacketMessages(StorageFolder storageFolder)
        //{
        ...
        //          {
        //              PacketMessage2 packetMessage = Open(file);
