...
namespace PacketMessagingTS.Models
{
	...
	public class DistributionListArray
	{
		...
		public async Task OpenAsync()
		{
			...
			{
                _logHelper.Log(LogLevel.Error, $"Open Distribution List file failed: {e.Message}");
				return;
			}

			catch (Exception e)
			{
                _logHelper.Log(LogLevel.Error, $"Error opening file {file?.Path + distributionListsFileName}, {e}");
				return;
			}
			UpdateDictionary();
		}
		...
		public async Task SaveAsync()
		{
			...
			{
                _logHelper.Log(LogLevel.Error, $"Error saving {distributionListsFileName}, {e}");
				return;
			}
			UpdateDictionary();
			_dataChanged = false;
