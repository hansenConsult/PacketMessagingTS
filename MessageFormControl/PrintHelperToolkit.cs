...
namespace MessageFormControl
{
    ...
    /// It allows you to render a framework element perpage.
    /// </summary>
    ...
    public sealed class PrintHelper : IDisposable
    {
        /// <summary>
        ...
        public void Dispose()
        {
            ...
            _printCanvas = null;
            Microsoft.Toolkit.Uwp.Helpers.DispatcherHelper.ExecuteOnUIThreadAsync(() =>
            {
